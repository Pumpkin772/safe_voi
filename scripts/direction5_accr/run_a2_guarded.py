"""Memory-guarded single-process launcher for A2."""
...
def main() -> None:
    ...
    code = run_guarded(
        [sys.executable, str(REPO / "scripts/direction5_accr/run_a2_identification.py")],
        cwd=REPO, environment=environment, limits=limits,
        monitor_log=REPO / "logs_accr/A2/MEMORY_MONITOR.jsonl",
        summary_path=REPO / "logs_accr/A2/MEMORY_MONITOR_SUMMARY.json",
    )
