"""Memory-guarded launcher for the locked one-shot A7 final confirmation."""
...
def main() -> None:
    ...
    code = run_guarded(
        [sys.executable, str(REPO / "scripts/direction5_accr/run_a7_final.py")],
        cwd=REPO, environment=environment, limits=limits,
        monitor_log=REPO / "logs_accr/A7/MEMORY_MONITOR.jsonl",
        summary_path=REPO / "logs_accr/A7/MEMORY_MONITOR_SUMMARY.json",
    )
