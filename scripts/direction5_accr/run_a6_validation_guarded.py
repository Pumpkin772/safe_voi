"""Memory-guarded launcher for locked A6 validation."""
...
def main() -> None:
    ...
    code = run_guarded(
        ...
        monitor_log=REPO / "logs_accr/A6/validation/MEMORY_MONITOR.jsonl",
        summary_path=REPO / "logs_accr/A6/validation/MEMORY_MONITOR_SUMMARY.json",
    )
