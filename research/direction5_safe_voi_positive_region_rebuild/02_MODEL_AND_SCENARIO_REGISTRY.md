...
distribution frozen before validation.  Both contract and probe policies use
the same event draws and normalized frequency/ACE/tie objective.
...
4. one or more load/regulation events independently sampled after 210 s;
...
- probe amplitude: 0.0005–0.005 pu;
